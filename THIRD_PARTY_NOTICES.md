...
- This file is generated during build_release.cmd from the backend build venv.
- To force backend rebuild: set SISRUA_REBUILD_BACKEND_EXE=1 then run build_release.cmd.

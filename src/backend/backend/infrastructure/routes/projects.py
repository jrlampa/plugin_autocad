...
from backend.domain.dto import ProjectCreateRequest, ProjectUpdateRequest
from backend.infrastructure.routes.deps import project_service
from backend.application.projects import ConflictError, NotFoundError

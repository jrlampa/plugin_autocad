# Documentação do sisRUA

Esta pasta reúne a documentação “de produto” e “de engenharia” do sisRUA.
...
- **EULA**: veja `../EULA.md`
- **Privacidade**: veja `../PRIVACY.md`
- **Third-party notices**: veja `../THIRD_PARTY_NOTICES.md`
